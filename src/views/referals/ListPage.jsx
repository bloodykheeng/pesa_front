...
import { getAllReferals, getReferalById, postReferal, updateReferal, deleteReferalById } from "../../services/referals/referals-service";
...
function ListPage({ ...props }) {
    ...
    const { data, isLoading, isError, error, status } = useQuery({
        queryKey: ["referals"],
        queryFn: getAllReferals,
    });
    console.log("🚀Referals ~ ListPage ~ data:", data);
    // useEffect(() => {
    //     if (isError) {
    ...
    const deleteMutation = useMutation({
        mutationFn: (variables) => deleteReferalById(variables),
        onSuccess: (data) => {
    ...
    return (
        <div style={{ width: "100%" }}>
            ...
            <Panel header="Referrals" style={{ marginBottom: "20px" }} toggleable>
                ...
                <MuiTable
                    ...
                    //
                    exportButton={true}
                    pdfExportTitle="Referrals"
                    csvExportTitle="Referrals"
                />
