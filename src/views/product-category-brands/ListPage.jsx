...
function ListPage({ loggedInUserData, productCategoryId, ...props }) {
    ...
    return (
        <div style={{ width: "100%" }}>
            ...
            <Panel header="Product Sub Category" style={{ marginBottom: "20px" }}>
                <div style={{ height: "3rem", margin: "1rem", display: "flex", justifyContent: "flex-end", gap: "1rem" }}>
                    {activeUser?.permissions.includes("create") && <Button label="Add Product Sub Category" className="p-button-primary" onClick={() => setShowAddForm(true)} />}
                ...
                <MuiTable
                    ...
                    handleViewPage={(rowData) => {
                        navigate("product-sub-category", { state: { productSubCategoryData: rowData } });
                    }}
                    showViewPage={true}
                    hideRowViewPage={false}
                    //
                    exportButton={true}
                    pdfExportTitle="Product Sub Categories"
                    csvExportTitle="Product Sub Categories"
                />
