...
function EditForm(props) {
    ...
    const editMutation = useMutation({
        mutationFn: (variables) => updateInventoryType(props?.rowData?.id, variables),
        onSuccess: () => {
    ...
    const handleSubmit = async (data) => {
        ...
        // Assuming 'photo' is the field name for the file upload
    ...
    return (
        <Dialog header="Inventory Types Form" visible={props.show} maximizable style={{ minWidth: "50vw" }} onHide={() => props.onHide()}>
